...
public class TimelineTab2 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v=inflater.inflate(R.layout.timeline_tab2, container, false);
        allEvents= (RecyclerView) v.findViewById(R.id.timelineTab2);
