...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Typeface customfont=Typeface.createFromAsset(context.getAssets(),"fonts/Brandon_med.otf");
        ...
        listViewHolder.musicName.setTypeface(customfont);
        listViewHolder.musicAuthor.setTypeface(customfont);
