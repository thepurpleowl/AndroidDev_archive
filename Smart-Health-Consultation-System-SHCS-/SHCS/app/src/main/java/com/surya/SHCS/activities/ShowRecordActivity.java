...
public class ShowRecordActivity extends AppCompatActivity {
    ...
    private AppCompatActivity activity = ShowRecordActivity.this;
    ...
    private void initObjects() {
        ...
        usersRecyclerAdapter = new RecordRecyclerAdapter(listUsers);
    ...
    private void getDataFromSQLite() {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                listUsers.clear();
                listUsers.addAll(databaseHelper.getAllAppointment(email));
