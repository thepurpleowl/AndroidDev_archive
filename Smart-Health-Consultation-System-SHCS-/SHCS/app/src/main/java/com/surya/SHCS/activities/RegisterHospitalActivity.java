...
public class RegisterHospitalActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private final AppCompatActivity activity = RegisterHospitalActivity.this;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.appCompatButtonRegister:
                ...
                hospitalIntent.putExtra("HOSPITAL_NAME", textInputEditTextName.getText().toString().trim());
...
//                finish();
    ...
    private void postDataToSQLite() {
        ...
        if (!databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim())) {
            ...
            databaseHelper.addHospital(user);
