...
public class TimelineTab3 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v=inflater.inflate(R.layout.timeline_tab3, container, false);
        allEvents= (RecyclerView) v.findViewById(R.id.timelineTab3);
